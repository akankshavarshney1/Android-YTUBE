...
import free.rm.Video.app.FeedUpdateTask;
import free.rm.Video.app.VideoMain;
import free.rm.Video.app.utils.WeaklyReferencedMap;
import free.rm.Video.businessobjects.Logger;
import free.rm.Video.databinding.FragmentMainBinding;
import free.rm.Video.databinding.SubsDrawerBinding;
import free.rm.Video.gui.activities.BaseActivity;
import free.rm.Video.gui.businessobjects.adapters.SubsAdapter;
...
public class MainFragment extends FragmentEx {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
		...
		if (args != null && args.getBoolean(SHOULD_SELECTED_FEED_TAB, false)) {
			...
			Set<String> hiddenFragments = VideoMain.getSettings().getHiddenTabs();
	...
	private static String[] getTabListValues() {
		return VideoMain.getStringArray(R.array.tab_list_values);
	}
	...
	public void onResume() {
		...
		if (VideoMain.getSettings().isFullRefreshTimely()) {
...
//		subsAdapter.setContext(null);
	...
	public class SimplePagerAdapter extends FragmentPagerAdapter {
		...
		synchronized void setupVisibleTabs() {
			visibleTabs.clear();
			Set<String> hiddenTabs = VideoMain.getSettings().getHiddenTabs();
		...
		public synchronized CharSequence getPageTitle(int position) {
			...
			if (tabKey != null) {
				return VideoMain.getFragmentNames().getName(tabKey);
			}
			return "Unknown";
		}
