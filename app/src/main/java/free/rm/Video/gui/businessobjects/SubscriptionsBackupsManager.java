...
import free.rm.Video.gui.businessobjects.preferences.BackupDatabases;
...
public class SubscriptionsBackupsManager {
    ...
    private void displayFilePicker(final boolean importDb) {
        ...
        if(importDb) {
            dialog.withFilter(false, false, "Video");
        } else {
                ...
                Single.fromCallable(() -> {
                    ...
                    return true;
                        ...
                        .subscribe(successfulImport -> {
                            ...
                            VideoMain.getSettings().updateFeedsLastUpdateTime(null);
                            ...
                            new AlertDialog.Builder(activity)
                                    ...
                                    .setNeutralButton(R.string.restart, (dialog, which) -> VideoMain.restartApp())
                                    .show();
                        })
        );
    }
        ...
        return Single.fromCallable(() -> {
            ...
            if (extractor != null && extension != null) {
                ...
                try (InputStream input = activity.getContentResolver().openInputStream(uri)) {
                    ...
                    VideoMain.notifyUserOnError(activity, e);
                }
            }
            ...
            return dialog;
                ...
                .map(inputs -> {
                    ...
                    Toast.makeText(activity,
                            String.format(VideoMain.getStr(R.string.subscriptions_to_channels_imported), totalChannelsSubscribedTo),
                            Toast.LENGTH_SHORT).show();

                    // refresh the Feed tab so it shows videos from the newly subscribed channels
                    VideoMain.getSettings().setRefreshSubsFeedFull(true);
