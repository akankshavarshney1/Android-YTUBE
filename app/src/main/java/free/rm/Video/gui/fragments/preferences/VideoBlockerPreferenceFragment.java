...
import free.rm.Video.gui.businessobjects.MultiSelectListPreferenceDialog;
import free.rm.Video.gui.businessobjects.MultiSelectListPreferenceItem;
...
public class VideoBlockerPreferenceFragment extends PreferenceFragmentCompat {
	...
	private void initChannelFilteringPreferences(Preference channelBlacklistPreference, Preference channelWhitelistPreference) {
		...
		final String channelFilter = VideoMain.getPreferenceManager().getString(getString(R.string.pref_key_channel_filter_method), getString(R.string.channel_blacklisting_filtering));
	...
	private class PreferredLanguageDialog extends MultiSelectListPreferenceDialog {
		public PreferredLanguageDialog(@NonNull Context context) {
			...
			onPositive((dialog, which) -> {
				...
				if (preferredLangIsoCodes.size() > 0) {
					SharedPreferences sharedPref = VideoMain.getPreferenceManager();
		...
		private Set<String> getPreferredLanguages() {
			SharedPreferences pref = VideoMain.getPreferenceManager();
