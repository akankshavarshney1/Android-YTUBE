...
import free.rm.Video.gui.businessobjects.YoutubePlayerMediaSession;
import free.rm.Video.gui.businessobjects.fragments.FragmentEx;
import free.rm.Video.gui.fragments.YouTubePlayerTutorialFragment;
import free.rm.Video.gui.fragments.YouTubePlayerV1Fragment;
import free.rm.Video.gui.fragments.YouTubePlayerV2Fragment;
...
public class YouTubePlayerActivity extends BaseActivity implements YouTubePlayerActivityListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (VideoMain.getSettings().wasTutorialDisplayedBefore()) {
	...
	private boolean useDefaultPlayer() {
		...
		final String str = VideoMain.getPreferenceManager().getString(getString(R.string.pref_key_choose_player), defaultPlayerValue);
	...
	protected void onStart() {
		...
		String  str = VideoMain.getPreferenceManager().getString(getString(R.string.pref_key_screen_orientation), getString(R.string.pref_screen_auto_value));
