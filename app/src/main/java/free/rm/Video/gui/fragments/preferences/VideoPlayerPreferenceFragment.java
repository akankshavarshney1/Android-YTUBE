...
public class VideoPlayerPreferenceFragment extends BasePreferenceFragment {
	...
	public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
		...
		creditsPref.setOnPreferenceClickListener(preference -> {
			VideoMain.getSettings().showTutorialAgain();
			return true;
		});
	...
	private void configureCountrySelector() {
		...
		String[] countryCodes = VideoMain.getStringArray(R.array.country_codes);
		String[] countryNames = VideoMain.getStringArray(R.array.country_names);
