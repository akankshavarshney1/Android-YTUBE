...
import free.rm.Video.databinding.BlockedVideoItemBinding;
import free.rm.Video.gui.activities.PreferencesActivity;
import free.rm.Video.gui.fragments.preferences.VideoBlockerPreferenceFragment;
...
public class BlockedVideosDialog extends SkyTubeMaterialDialog {
	...
	public static class BlockedVideosAdapter extends RecyclerView.Adapter<ViewHolder> {
		...
		private final int[] rowColors = new int[] {VideoMain.getColorEx(R.color.dialog_row_0), VideoMain.getColorEx(R.color.dialog_row_1)};
