...
import free.rm.Video.businessobjects.YouTube.ValidateYouTubeAPIKey;
...
public class OthersPreferenceFragment extends BasePreferenceFragment {
	...
	public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
		...
		Set<String> hiddenFragments = VideoMain.getPreferenceManager().getStringSet(getString(R.string.pref_key_hide_tabs), new HashSet<>());
		final String[] tabListValues = VideoMain.getStringArray(R.array.tab_list_values);
		final String[] tabListLabels = VideoMain.getFragmentNames().getAllNames(tabListValues);
...
//		feedNotificationPref.setSummary(String.format(getString(R.string.pref_summary_feed_notification), feedNotificationPref.getEntry()));
	...
	private void displayRestartDialog(int messageID, boolean restart) {
		final AlertDialog.Builder b = new AlertDialog.Builder(getActivity())
				...
				.setCancelable(false);
		if (restart) {
			b.setPositiveButton(R.string.restart, (dialog, which) -> VideoMain.restartApp());
		} else {
