...
import free.rm.Video.businessobjects.FeedUpdaterReceiver;
 ...
 * SkyTube application.
 */
public class VideoMain extends MultiDexApplication {

	/** SkyTube Application databaseInstance. */
	private static VideoMain skyTubeApp = null;
	...
	public static final String NEW_VIDEOS_NOTIFICATION_CHANNEL = "free.rm.Video.NEW_VIDEOS_NOTIFICATION_CHANNEL";
	...
	public static ContentId parseUrl(@NonNull Context context, String url, boolean showErrorIfNotValid) {
		try {
			...
			VideoMain.notifyUserOnError(context, e);
			return null;
		}
	...
	public static boolean openContent(Context ctx, ContentId content) {
		...
		switch (content.getType()) {
			...
			case CHANNEL: {
				VideoMain.launchChannel(content.getId(), ctx);
				break;
			}
			case PLAYLIST: {
