...
import free.rm.Video.businessobjects.YouTube.POJOs.YouTubeAPI;
...
public class GetFeaturedVideos extends GetYouTubeVideos {
	...
	private String getPreferredRegion() {
		String region = VideoMain.getPreferenceManager()
				.getString(VideoMain.getStr(R.string.pref_key_preferred_region), "").trim();
