...
import free.rm.Video.businessobjects.YouTube.POJOs.YouTubeAPIKey;
...
import free.rm.Video.businessobjects.YouTube.newpipe.NewPipeException;
import free.rm.Video.businessobjects.YouTube.newpipe.NewPipeService;
import free.rm.Video.businessobjects.YouTube.newpipe.PlaylistPager;
import free.rm.Video.businessobjects.db.SubscriptionsDb;
...
import static free.rm.Video.app.VideoMain.getContext;
...
public class YouTubeTasks {
    ...
    public static Single<Integer> refreshAllSubscriptions(Context context, @Nullable Consumer<List<String>> subscriptionListConsumer, @Nullable Consumer<Integer> newVideosFound) {
        ...
        return subscriptionList
                ...
                .doOnError(error -> {
                    VideoMain.notifyUserOnError(context, error);
                })
                .doOnSuccess(changed -> {
                    Log.i("YouTubeTasks", "refreshAllSubscriptions: " + changed);
                    VideoMain.getSettings().updateFeedsLastUpdateTime();
                });
    }
    ...
    public static Maybe<List<YouTubePlaylist>> getChannelPlaylists(@NonNull Context ctx,
        ...
        return Single.fromCallable(getChannelPlaylists::getNextPlaylists)
                ...
                .doOnError(throwable -> {
                    ...
                    VideoMain.notifyUserOnError(ctx, throwable);
                })
    ...
    public static Single<YouTubePlaylist> getPlaylist(@NonNull Context context, @NonNull String playlistId) {
        return Single.fromCallable(() -> {
            ...
            return pager.getPlaylist();
                ...
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnError(throwable -> VideoMain.notifyUserOnError(context, throwable));
    }
    ...
    private static Single<Integer> getSubscriptionVideos(@NonNull List<String> channelIds, @Nullable Consumer<Integer> newVideosFound) {
         ...
         * any.
         */
        final Long publishedAfter = VideoMain.getSettings().getFeedsLastUpdateTime();
        final AtomicBoolean changed = new AtomicBoolean(false);
        ...
        return Single.fromCallable(() -> {
            ...
            return youTubeVideo.getDescription();
                ...
                .onErrorReturn(throwable -> {
                    ...
                    return VideoMain.getStr(R.string.error_get_video_desc);
                });
    }
    ...
    public static Maybe<YouTubeVideo> getVideoDetails(@NonNull Context context,
        ...
        return Maybe.fromCallable(() -> NewPipeService.get().getDetails(content.getId()))
                ...
                .doOnError(throwable -> {
                    ...
                    VideoMain.notifyUserOnError(context, throwable);
                })
                .onErrorComplete();
    }
    ...
    public static Maybe<YouTubeVideo> getVideoDetails(@NonNull Context context,
        ...
        final ContentId content = VideoMain.getUrlFromIntent(context, intent);
        ...
        return Maybe.fromCallable(() -> {
            ...
            return videosList;
                ...
                .doOnSuccess(videosList -> {
                    VideoMain.notifyUserOnError(context, getYouTubeVideos.getLastException());
