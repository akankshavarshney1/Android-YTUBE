package free.rm.Video.businessobjects.db;
...
import free.rm.Video.gui.businessobjects.views.SubscribeButton;
...
public class DatabaseTasks {
    ...
    public static Maybe<YouTubeChannel> getChannelInfo(@NonNull Context context,
        ...
        return Maybe.fromCallable(() -> {
            ...
            if (needsRefresh && VideoMain.isConnected(context)) {
    ...
    public static Single<List<ChannelView>> getSubscribedChannelView(@Nullable View progressBar,
        ...
        final boolean sortChannelsAlphabetically = VideoMain.getPreferenceManager()
                .getBoolean(VideoMain.getStr(R.string.pref_key_subscriptions_alphabetical_order), false);
        if (progressBar != null) {
            ...
            if (subscribeToChannel) {
                ...
                .doOnSuccess(databaseResult -> {
                    if (databaseResult == DatabaseResult.SUCCESS) {
                        ...
                        VideoMain.getSettings().setRefreshSubsFeedFromCache(true);
                        ...
                        String err = String.format(VideoMain.getStr(R.string.error_unable_to_subscribe), channel.getId());
