...
public class YouTubeAPIKey {
	 ...
	 * {@link free.rm.Video.gui.fragments.preferences.OthersPreferenceFragment}.  Will be null if the user did not
	 * input a key. **/
	 ...
	 * {@link free.rm.Video.gui.fragments.preferences.OthersPreferenceFragment}); false otherwise.
	 */
	...
	private String getUserApiKey() {
		String userApiKey = VideoMain.getPreferenceManager().getString(VideoMain.getStr(R.string.pref_youtube_api_key), null);
