...
import free.rm.Video.gui.activities.PermissionsActivity;
...
public abstract class FileDownloader implements Serializable, PermissionsActivity.PermissionsTask {
	...
	private void download() {
		...
		String videoDir = VideoMain.getSettings().getDownloadFolder(null);
		if(videoDir != null) {
	...
	private class FileInformation {
		...
		public FileInformation(String downloadFileName,
			...
			boolean toDirectories = VideoMain.getSettings().isDownloadToSeparateFolders();
