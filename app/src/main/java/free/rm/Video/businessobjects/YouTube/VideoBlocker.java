...
package free.rm.Video.businessobjects.YouTube;
...
import free.rm.Video.businessobjects.YouTube.POJOs.ChannelView;
import free.rm.Video.businessobjects.YouTube.POJOs.YouTubeVideo;
import free.rm.Video.businessobjects.db.ChannelFilteringDb;

import static free.rm.Video.app.VideoMain.getStr;
...
public class VideoBlocker {
	...
	private static final Set<String> defaultPrefLanguages = new HashSet<>(VideoMain.getStringArrayAsList(R.array.languages_iso639_codes));
	...
	public List<CardData> filter(List<CardData> videosList) {
		...
		final Set<String>   preferredLanguages    = VideoMain.getPreferenceManager().getStringSet(getStr(R.string.pref_key_preferred_languages), defaultPrefLanguages);
	...
	private boolean isVideoBlockerEnabled() {
		return VideoMain.getPreferenceManager().getBoolean(getStr(R.string.pref_key_enable_video_blocker), true);
	}
	...
	public static boolean isChannelBlacklistEnabled() {
		final String channelFilter = VideoMain.getPreferenceManager().getString(getStr(R.string.pref_key_channel_filter_method), getStr(R.string.channel_blacklisting_filtering));
	...
	private boolean filterByLanguageDetection(YouTubeVideo video, Set<String> preferredLanguages) {
		...
		if (!VideoMain.getPreferenceManager().getBoolean(getStr(R.string.pref_key_lang_detection_video_filtering), false))
			return false;
	...
	private BigInteger getViewsFilteringValue() {
		final  String viewsFiltering = VideoMain.getPreferenceManager().getString(getStr(R.string.pref_key_low_views_filter), getStr(R.string.views_filtering_disabled));
	...
	private int getDislikesFilteringValue() {
		final  String dislikesFiltering = VideoMain.getPreferenceManager().getString(getStr(R.string.pref_key_dislikes_filter), getStr(R.string.dislikes_filtering_disabled));
