...
import free.rm.Video.databinding.FragmentChromecastMiniControllerBinding;
...
public class ChromecastMiniControllerFragment extends ChromecastBaseControllerFragment {
	public static final String CHROMECAST_MINI_CONTROLLER_FRAGMENT = "free.rm.Video.CHROMECAST_MINI_CONTROLLER_FRAGMENT";

	/** The {@link free.rm.Video.businessobjects.ChromecastListener} Activity that will be notified when play has started and stopped */
