...
import free.rm.Video.databinding.FragmentChromecastControllerBinding;
...
public class ChromecastControllerFragment extends ChromecastBaseControllerFragment implements SeekBar.OnSeekBarChangeListener {
	public static final String CHROMECAST_CONTROLLER_FRAGMENT = "free.rm.Video.CHROMECAST_CONTROLLER_FRAGMENT";
