...
import free.rm.Video.businessobjects.ChromecastListener;
...
import free.rm.Video.gui.fragments.ChromecastControllerFragment;
import free.rm.Video.gui.fragments.ChromecastMiniControllerFragment;
...
public abstract class BaseActivity extends AppCompatActivity implements MainActivityListener, ChromecastListener {
	...
	public static final String ACTION_NOTIFICATION_CLICK = "free.rm.Video.ACTION_NOTIFICATION_CLICK";

	public static final String PANEL_EXPANDED = "free.rm.Video.PANEL_EXPANDED";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(googlePlayServicesAvailable) {
			...
			final SharedPreferences preferences = VideoMain.getPreferenceManager();
    ...
    /**
     * When returning to {@link free.rm.Video.gui.fragments.MainFragment} from a fragment that uses
	...
	public void playVideoOnChromecast(final YouTubeVideo video, final int position) {
		...
		if(video.getDescription() == null) {
			...
			compositeDisposable.add(
					...
					StreamSelectionPolicy policy = VideoMain.getSettings().getDesiredVideoResolution(false).withAllowVideoOnly(false);
